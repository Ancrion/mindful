...
const seed = [
    ...
    ["1.5.0", "2026-06-10", "Bug-Seite Full-Screen-Redesign", '["Bug-Seite füllt jetzt die gesamte Bildschirmhöhe","Layout zentriert (max-width: 1400px + margin: 0 auto)","Kanban-Spalten scrollen einzeln (overflow-y: auto)","bugs-content + kanban nutzen flex: 1 für dynamische Höhenverteilung","app-layout > main: min-height: 0 für korrektes Flex-Verhalten"]', '["bugs-main hatte fixe max-width: 1200px ohne flex: 1 – Kanban wuchs nie über Inhalt","kanban-cards hatten min-height: 80px und kein overflow – Karten quollen über","bugs-content hatte kein flex: 1 – Formular und Kanban verteilten sich nicht"]', '["24f0d15"]'],
  ];
