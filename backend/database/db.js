...
const seed = [
    ...
    ["1.4.0", "2026-06-10", "Workspace-Kontextmenü & fix Sidebar-DnD", '["Rechtsklick-Kontextmenü für Workspaces in der Sidebar (Unter-Workspace anlegen, Umbenennen, Löschen)","Workspace-DnD funktioniert jetzt auch auf der Todo-Seite"]', '["Naming-Konflikt loadWorkspaces zwischen app.js/todo.js behoben – Sidebar-Baum wurde auf Todo-Seite nie gerendert","quickCreateWsSidebar nutzt jetzt dataset.parentId aus dem Kontextmenü"]', '["4f85ce9"]'],
  ];
